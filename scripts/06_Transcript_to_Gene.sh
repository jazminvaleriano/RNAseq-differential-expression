...
join --nocheck-order -t $'\t' -a 1 -a 2 -1 1 -2 1 $OUTPUT_DIR/transcripts.tsv $OUTPUT_DIR/biotype.tsv > $OUTPUT_DIR/transcript_to_gene.tsv

rm transcripts.tsv biotype.tsv
